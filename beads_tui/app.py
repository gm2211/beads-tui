...
# Textual DataTable hover/click events can render badly under some terminals/multiplexers
# (ghost header rows, doubled headers). Suppress all mouse events to keep the table
# keyboard-only and prevent rendering artifacts in Docker/Zellij environments.
